 ...
 <q-card-section>
    ...
    >
     ...
     <div class="col-12 col-md-6 q-pa-md">
       ...
       <q-input v-model="password_new_confirmation" label="Repita a nova senha" filled :type="isPwd ? 'password' : 'text'" hint="Password with toggle">
        <template v-slot:append>
          <q-icon
            :name="isPwd ? 'visibility_off' : 'visibility'"
            class="cursor-pointer"
...
export default {
    data(){
        return {
            user:{
                name:'', address1:'', address2:'', address:'', address3:'', email:'', email1:'', website:'', telephone:'', telephone1:'', 
            },
            password:'',
            password_new:'',
